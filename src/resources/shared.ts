...
import { EnvironmentClassesPage, GatewaysPage, ProjectEnvironmentClassesPage, TaskExecutionsPage, TasksPage } from '../core/pagination';
...
export type CountResponseRelation = 'COUNT_RESPONSE_RELATION_UNSPECIFIED' | 'COUNT_RESPONSE_RELATION_EQ' | 'COUNT_RESPONSE_RELATION_GTE'
 ...
 */
export type ErrorCode = 'canceled' | 'unknown' | 'invalid_argument' | 'deadline_exceeded' | 'not_found' | 'already_exists' | 'permission_denied' | 'resource_exhausted' | 'failed_precondition' | 'aborted' | 'out_of_range' | 'unimplemented' | 'internal' | 'unavailable' | 'data_loss' | 'unauthenticated'
...
export type OrganizationRole = 'ORGANIZATION_ROLE_UNSPECIFIED' | 'ORGANIZATION_ROLE_ADMIN' | 'ORGANIZATION_ROLE_MEMBER'

export type OrganizationTier = 'ORGANIZATION_TIER_UNSPECIFIED' | 'ORGANIZATION_TIER_FREE' | 'ORGANIZATION_TIER_ENTERPRISE' | 'ORGANIZATION_TIER_CORE' | 'ORGANIZATION_TIER_FREE_ONA'

export type Principal = 'PRINCIPAL_UNSPECIFIED' | 'PRINCIPAL_ACCOUNT' | 'PRINCIPAL_USER' | 'PRINCIPAL_RUNNER' | 'PRINCIPAL_ENVIRONMENT' | 'PRINCIPAL_SERVICE_ACCOUNT' | 'PRINCIPAL_RUNNER_MANAGER'
...
export type TaskExecutionPhase = 'TASK_EXECUTION_PHASE_UNSPECIFIED' | 'TASK_EXECUTION_PHASE_PENDING' | 'TASK_EXECUTION_PHASE_RUNNING' | 'TASK_EXECUTION_PHASE_SUCCEEDED' | 'TASK_EXECUTION_PHASE_FAILED' | 'TASK_EXECUTION_PHASE_STOPPED'
...
export type UserStatus = 'USER_STATUS_UNSPECIFIED' | 'USER_STATUS_ACTIVE' | 'USER_STATUS_SUSPENDED' | 'USER_STATUS_LEFT'
...
export type ProjectEnvironmentClassesProjectEnvironmentClassesPage = ProjectEnvironmentClassesPage<ProjectEnvironmentClass>
